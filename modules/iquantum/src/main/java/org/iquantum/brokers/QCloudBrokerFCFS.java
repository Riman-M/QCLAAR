...
/**
 * Quantum Cloud Broker with FCFS / First-Feasible backend selection.
 *
 * Policy:
 ...
 *
 * This class preserves the original QCloudBroker event flow and only
 * replaces lottery-based backend selection with deterministic FCFS selection.
 */
public class QCloudBrokerFCFS extends QCloudBroker {

    public QCloudBrokerFCFS(String name) throws Exception {
        super(name);
    }
