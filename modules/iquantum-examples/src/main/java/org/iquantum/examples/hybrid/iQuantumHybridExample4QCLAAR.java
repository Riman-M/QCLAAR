...
public class iQuantumHybridExample4QCLAAR {
...
//        Log.disable();
        ...
        try {
            PrintStream fileOut = new PrintStream(
                    new FileOutputStream("iQuantumCloudEdgeExample4QCLAAR.txt")
            );
        ...
        String exampleName = "iQuantumCloudEdgeExample4QCLAAR";
        ...
        QCloudBrokerQCLAAR qcBroker = createQCBroker();
...
//        String folderPath = "dataset/iquantum/MQT-Set03-7-127-AllOpt-IBMMapped-Only127-Extra.csv";
    ...
    private static QCloudBrokerQCLAAR createQCBroker() {
        try {
