...
public class iQuantumHybridExample4LoadAware {
...
//        Log.disable();
        ...
        try {
            PrintStream fileOut = new PrintStream(
                    new FileOutputStream("iQuantumCloudEdgeExample4LoadAware.txt")
            );
        ...
        String exampleName = "iQuantumCloudEdgeExample4LoadAware";
        ...
        QCloudBrokerLoadAware qcBroker = createQCBroker();
...
//        String folderPath = "dataset/iquantum/MQT-Set03-7-127-AllOpt-IBMMapped-Only127-Extra.csv";
    ...
    private static QCloudBrokerLoadAware createQCBroker() {
        try {
